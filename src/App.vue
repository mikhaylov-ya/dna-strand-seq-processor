  ...
  <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
      <div class="-space-y-px rounded-md shadow-sm">
        <div class="container">
          <p class="my-5 text-4xl font-bold tracking-tight text-gray-900">
            Enter a DNA strand nucleotide sequence
          </p>
          ...
          <input
            ...
            class="
              text-xs block w-full appearance-none rounded-none
